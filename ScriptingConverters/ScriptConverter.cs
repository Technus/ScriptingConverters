...
namespace ScriptingConverters
{
  ...
  public class ScriptConverter : IValueConverter
  {
    ...
    /// </summary>
    protected static IDictionary<string, (Script<object> script, ScriptRunner<object> runner)> Scripts { get; } =
  ...
  public class ScriptConverter<T, V, P> : IValueConverter
  {
    ...
    /// <see cref="ScriptStorage{G, T}.Scripts"/>
    /// </summary>
    protected static IDictionary<string, (Script<V> script, ScriptRunner<V> runner)> Scripts { get; } =
